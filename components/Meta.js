...
function Meta(props) {
  ...
  const globalMeta = {
    ...
    domain: "",
    // Your Twitter handle (example: @bassureofficial)
    twitterHandle: "",
  };
  ...
  const defaultPageMeta = {
    ...
    // Page description
    description: "From centralizing employee records to managing employee time-off, EMS unifies and simplifies HR data management - all in one place.",
